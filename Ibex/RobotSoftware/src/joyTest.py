...
class JoystickReader:
    ...
    def updateValues(self):
        ...
        self.axis_x2 = deadband(self.joystick.get_axis(2))
        self.axis_y2 = deadband(self.joystick.get_axis(3))
        self.axis_lt = deadband(self.joystick.get_axis(4))
    ...
    def printAxes(self):
        print "LeftX:" + str(self.axis_x1)
        print "LeftY:" + str(self.axis_y1)
        print "RightX:" + str(self.axis_x2)
        print "RightY:" + str(self.axis_y2)
        print "LeftTrig:" + str(self.axis_lt)
        print "RightTrig:" + str(self.axis_rt)
