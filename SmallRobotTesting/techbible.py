...
class GripPipeline:
    ...
    def __init__(self):
        ...
        self.__rgb_threshold_red = [98.60611510791367, 255.0]
        self.__rgb_threshold_green = [29.81115107913669, 62.34295415959252]
        self.__rgb_threshold_blue = [0.0, 49.787775891341255]
