...
class RedObjectPipeline:
    ...
    def __init__(self):
        ...
        self.__rgb_threshold_red = [80.26079136690647, 255.0]
        self.__rgb_threshold_green = [0.0, 42.86078098471985]
        self.__rgb_threshold_blue = [0.0, 77.92869269949067]
        ...
        self.__filter_contours_min_area = 420.0
